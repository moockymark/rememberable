...
class Builder extends \Illuminate\Database\Query\Builder
{
    ...
    {
        if ( ! is_null($this->cacheSeconds)) {
            return $this->countCached($columns);
        }
     ...
     * @return int
     */
    public function countCached($columns = '*')
    {
        if (is_null($this->columns)) {
            $this->columns = $columns;
        }
        ...
        $callback = $this->countCacheCallback($columns);
     ...
     * @return \Closure
     */
    protected function countCacheCallback($columns)
    {
        return function () use ($columns) {
            $this->cacheSeconds = null;
